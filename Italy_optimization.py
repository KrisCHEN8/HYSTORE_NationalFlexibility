...
Cm_dict_ave = {
    'Cm_h': 254761.18 * 0.001 * 12,   # MWh
    'Cm_c': 815840.28 * 0.001 * 12    # MWh
}

Cm_dict_70p = {
    'Cm_h': 521523.24 * 0.001 * 12,   # MWh
    'Cm_c': 1989612.33 * 0.001 * 12   # MWh
}

Cm_dict_50p = {
    'Cm_h': 372516.60 * 0.001 * 12,   # MWh
    'Cm_c': 1421151.66 * 0.001 * 12   # MWh
}
...
if solver == 'PSO':
    ...
    df_results.to_excel('./res_12/IT/results_IT_aveCm_12.xlsx', index=True)
    ...
    df_results['modified_load'] = df_results['actual_load'] + heating + cooling
    df_results['surplus_optimized'] = df_results['surplus'] - (df_results['y_TCM_h'] + df_results['y_PCM_h'] + df_results['y_TCM_c'] + df_results['y_PCM_c'])  # noqa: E501
    df_results.to_excel('./res_12/IT/results_IT_70PCm_12.xlsx', index=True)
    ...
    df_results['modified_load'] = df_results['actual_load'] + heating + cooling
    df_results['surplus_optimized'] = df_results['surplus'] - (df_results['y_TCM_h'] + df_results['y_PCM_h'] + df_results['y_TCM_c'] + df_results['y_PCM_c'])  # noqa: E501
    df_results.to_excel('./res_12/IT/results_IT_50PCm_12.xlsx', index=True)
