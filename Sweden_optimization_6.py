...
Cm_dict_ave = {
    'Cm_h': 157664.92 * 0.001 * 6,   # MWh
    'Cm_c': 0 * 0.001    # MWh
}

Cm_dict_70p = {
    'Cm_h': 1194809.98 * 0.001 * 6,   # MWh
    'Cm_c': 0 * 0.001   # MWh
}

Cm_dict_50p = {
    'Cm_h': 182477.33 * 0.001 * 6,   # MWh
    'Cm_c': 0 * 0.001   # MWh
}
...
if solver == 'Pyomo':
    ...
    df_results.to_excel('./res_6/SE/results_SE_aveCm_6.xlsx', index=True)
    ...
    df_results['modified_load'] = df_results['actual_load'] + heating + cooling
    df_results['surplus_optimized'] = df_results['surplus'] - (df_results['y_TCM_h'] + df_results['y_PCM_h'] + df_results['y_TCM_c'] + df_results['y_PCM_c'])  # noqa: E501
    df_results.to_excel('./res_6/SE/results_SE_70PCm_6.xlsx', index=True)
    ...
    df_results['modified_load'] = df_results['actual_load'] + heating + cooling
    df_results['surplus_optimized'] = df_results['surplus'] - (df_results['y_TCM_h'] + df_results['y_PCM_h'] + df_results['y_TCM_c'] + df_results['y_PCM_c'])  # noqa: E501
    df_results.to_excel('./res_6/SE/results_SE_50PCm_6.xlsx', index=True)
