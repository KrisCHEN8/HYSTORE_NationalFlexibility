...
country_code = 'IT_SARD' 
range_time_load="15T"
range_time_generation="15T"


column_names_load = ["Actual load"]
column_names_generation=["Biomass","Fossil Coal-derived gas","Fossil Hard Coal","Fossil Oil",
                         "Hydro Pumped Storage charge","Hydro Pumped Storage discharge","Hydro Run-of-river and poundage","Hydro Water Reservoir","Other","Solar","","Wind Onshore"]
...
column_indices_fossil = [1,2,3,8]
column_indices_renewables=[0,6,9,11]
column_indices_storage=[4,7]
...
df_simplified_calc.to_pickle('df_IT_SARD.pkl')