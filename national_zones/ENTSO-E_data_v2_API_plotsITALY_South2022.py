...
column_names_generation=["Biomass","Fossil Coal-derived gas","Fossil Gas","Fossil Hard Coal","","Fossil Oil","Hydro Run-of-river and poundage","Hydro Water Reservoir","Other","Solar","Wind Onshore"]
...
column_indices_fossil = [1,2,3,5,8]
column_indices_renewables=[0,6,9,10]
column_indices_storage=[7]
...
df_simplified_calc.to_pickle('df_IT_SUD.pkl')