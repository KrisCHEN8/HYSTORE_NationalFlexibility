...
#parameters
start = pd.Timestamp('20210101', tz='Europe/Stockholm')
end = pd.Timestamp('20220101', tz='Europe/Stockholm')
country_code = 'SE_2' 
range_time_load="15T"
...
column_names_generation=["Fossil Gas","Hydro Water Reservoir","Other","Solar","Wind Onshore"]
...
column_indices_fossil = [0,2]
column_indices_renewables=[3,4]
column_indices_storage=[1]
