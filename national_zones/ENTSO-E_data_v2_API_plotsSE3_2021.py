...
column_names_generation=["Fossil Gas","Hydro Water Reservoir","Marine","Nuclear","Other","Solar","Wind Onshore"]
...
column_indices_fossil = [0,4]
column_indices_renewables=[2,3,5,6]
