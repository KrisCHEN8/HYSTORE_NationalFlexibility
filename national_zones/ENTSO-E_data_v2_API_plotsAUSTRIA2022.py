...
#parameters
start = pd.Timestamp('20220101', tz='Europe/Vienna')
end = pd.Timestamp('20230101', tz='Europe/Vienna')
country_code = 'AT' 
range_time_load="15T"
...
#column_names_generation=["Biomass","Fossil Brown coal/Lignite","Fossil Gas","Fossil Hard coal","Fossil Oil","Geothermal","Hydro Pumped Storage_charge","Hydro Pumped Storage_discharge","Hydro Run-of-river and poundage","Other","Other renewable","Solar","Waste","Wind Offshore","Wind Onshore"]
column_names_generation=["Biomass","Biomass consumption","Fossil Gas","Fossil Gas consumption","Fossil Hard coal","Fossil Hard coal consumption","Fossil Oil","Fossil Oil consumption","Geothermal","Geothermal consumption",
                         "Hydro Pumped Storage charge","Hydro Pumped Storage discharge","Hydro Run-of-river and poundage","Hydro Run-of-river and poundage","Hydro Water Reservoir","Hydro Water Reservoir","Other","Other consumption","Other renewable",
                         "Other renewable","Solar","Solar consumption","Waste","Waste consumption","Wind Onshore","Wind Onshore"]
...
print(df_generation)
len(df_generation.columns)
len(column_names_generation)

#df_generation['Time'] = df_generation.index.values

#create the simplified dataframe with resources joined by type
column_indices_fossil = [2,4,6,17]
column_indices_renewables=[0,8,12,18,20,22,24]
column_indices_storage=[10,14]
...
#df_simplified_calc.to_pickle('df_AUS.pkl')