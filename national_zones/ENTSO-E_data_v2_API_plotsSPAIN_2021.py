...
#parameters
start = pd.Timestamp('20210101', tz='Europe/Madrid')
end = pd.Timestamp('20220101', tz='Europe/Madrid')
country_code = 'ES' 
range_time_load="15T"
...
column_names_generation=["Biomass","Fossil Brown coal/Lignite","Fossil Coal-derived gas","Fossil Gas","Fossil Hard coal","Fossil Oil","Fossil Oil shale","Fossil Peat","Geothermal",
                         "Hydro Pumped Storage charge","Hydro Run-of-river and poundage","Hydro Water Reservoir","Marine","Nuclear","Other","Other renewable",
...
df_generation['Time'] = df_generation.index
...
column_indices_fossil = [1,2,3,4,5,6,7,14]
column_indices_renewables=[0,8,10,12,13,15,16,17,18,19]
column_indices_storage=[9,11]
