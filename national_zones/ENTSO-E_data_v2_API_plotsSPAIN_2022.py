...
column_indices_fossil = [1,2,3,4,5,6,7,15]
column_indices_renewables=[0,8,11,13,14,16,17,18,19,20]
column_indices_storage=[9,12]
...
df_simplified_calc.to_pickle('df_ESP.pkl')