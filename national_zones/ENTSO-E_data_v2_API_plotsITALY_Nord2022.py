...
column_names_generation=["Biomass","Fossil Coal-derived gas","Fossil Gas","Fossil Hard Coal","Fossil Oil",
                         "Hydro Pumped Storage charge","Hydro Pumped Storage discharge","Hydro Run-of-river and poundage","Hydro Water Reservoir","Other","Solar","Waste","Wind Onshore"]
...
column_indices_fossil = [1,2,3,4,9]
column_indices_renewables=[0,7,10,11,12]
column_indices_storage=[5,8]
...
df_simplified_calc.to_pickle('df_IT_NORD.pkl')