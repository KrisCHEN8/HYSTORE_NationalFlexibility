...
# Input data
D_H = df_demand['Spain_heating_kWh'].values * 1e-6  # be consistant with the country in line 7  # noqa: E501
D_C = df_demand['Spain_cooling_kWh'].values * 1e-6  # be consistant with the country in line 7  # noqa: E501
...
Cm_dict_ave = {
    'Cm_h': 308836.95 * 1e-6,   # GWh
    'Cm_c': 146419.18 * 1e-6    # GWh
}

Cm_dict_70p = {
    'Cm_h': 669284.33 * 1e-6,   # GWh
    'Cm_c': 485496.01 * 1e-6   # GWh
}

Cm_dict_50p = {
    'Cm_h': 478060.24 * 1e-6,   # GWh
    'Cm_c': 346782.87 * 1e-6   # GWh
}
